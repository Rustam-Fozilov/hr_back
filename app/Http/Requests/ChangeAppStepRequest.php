...
class ChangeAppStepRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'branch_id'         => 'nullable|required_if:has_app,=,0|integer|exists:branches,id',
            'name'              => 'nullable|required_if:has_app,=,0|string',
            'surname'           => 'nullable|required_if:has_app,=,0|string',
            'patronymic'        => 'nullable|string',
            'phone'             => 'nullable|required_if:has_app,=,0|string',
            'pinfl'             => 'nullable|required_if:has_app,=,0|string|size:14',
            ...
            'passport_code'     => 'nullable|required_if:has_app,=,0|string',
            'passport_number'   => 'nullable|required_if:has_app,=,0|string',
            'passport_date'     => 'nullable|required_if:has_app,=,0|string|date_format:Y-m-d',
            'passport_end_date' => 'nullable|required_if:has_app,=,0|string|date_format:Y-m-d',

            'app_upload_id'           => 'nullable|required_if:has_app,=,0|integer|exists:uploads,id',
            'passport_upload_id'      => 'nullable|required_if:has_app,=,0|integer|exists:uploads,id',
            ...
            'diploma_upload_id'       => 'nullable|required_if:has_app,=,0|integer|exists:uploads,id',
            'inps_upload_id'          => 'nullable|required_if:has_app,=,0|integer|exists:uploads,id',
            'avatar_upload_id'        => 'nullable|required_if:has_app,=,0|integer|exists:uploads,id',
